  ...
  return (
    ...
    <nav className='navbar'>
      ...
      <ul className={click ? 'nav-menu active' : 'nav-menu'}>
        <li className='nav-item' onMouseEnter={hadndleSoc} onMouseLeave={handleSocc}>
            <Link to="/soccer" className='nav-links' onClick={closeMobileMenu}>
              SOCCER
            </Link>
            {soccerdropdown && <SoccerDropdown/>}
        </li>
        <li className='nav-item' onMouseEnter={hadndleBas} onMouseLeave={handleBask}>
            <Link to="/basketball" className='nav-links' onClick={closeMobileMenu}>
              BASKETBALL
            </Link>
            {basketballdropdown && <BasketBallDropdown/>}
        </li>
        <li className='nav-item' onMouseEnter={hadndleSto} onMouseLeave={handleStor}>
